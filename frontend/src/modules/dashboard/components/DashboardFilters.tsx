...
export default function DashboardFilters() {
  const { t } = useI18n()
  const { draft, filterError, setDraft, apply, reset } = useDashboardStore(useShallow((s) => ({
    draft: s.draft, filterError: s.filterError, setDraft: s.setDraft, apply: s.apply, reset: s.reset,
  })))
  return (
